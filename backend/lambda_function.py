...
# CORS configuration. Set CORS_ALLOW_ORIGIN to your frontend origin to avoid
# wildcard/allowlist mismatches with API Gateway settings.
CORS_ALLOWED_ORIGINS = [
    o.strip()
    for o in os.environ.get("CORS_ALLOW_ORIGIN", os.environ.get("ALLOWED_ORIGINS", "*")).split(",")
    if o.strip()
]
