                      ...
                      <TooltipTrigger asChild>
                        <div
                          ...
                          className={cn(
                            ...
                            isCollapsed ? "px-2 py-2.5 justify-center" : "px-2 py-1.5"
                          )}
                          tabIndex={0}
                          role="button"
                          onKeyDown={(event) => {
                        ...
                        >
                          ...
                          {!isCollapsed && (
                            <div className="flex flex-1 min-w-0 items-center gap-2 rounded-full px-2 py-1 group-hover:bg-sidebar-hover group-focus-within:bg-sidebar-hover transition-colors">
                              <span className="block flex-1 min-w-0 truncate text-xs text-foreground">
                                {chat.title}
                              </span>
