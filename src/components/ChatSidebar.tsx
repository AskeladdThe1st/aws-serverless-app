                    ...
                    <Tooltip key={chat.id} delayDuration={0}>
                      <TooltipTrigger asChild>
                        ...
                        >
                          ...
                          {!isCollapsed && (
                            <div className="flex flex-1 min-w-0 items-center gap-3 rounded-full px-3 py-1 group-hover:bg-sidebar-hover group-focus-within:bg-sidebar-hover transition-colors">
